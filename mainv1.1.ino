...
void calibrateLightSensor() {
    ...
    if (colorSensorValue < colorSensorMinValue) {
 ...
 */
int detectDisk(int photocellReading) {
 ...
 */
void driver() {
  int diskColor = detectDisk(photocellReading);
  switch (diskColor) {
    case 2://"White Disk":
      startBeltMotor(true);
      displayLCD("White Disk");
      break;
    case 0://"Black Disk":
      startBeltMotor(false);
      displayLCD("Black Disk");
      break;
    default:
      displayLCD("Other Color");
      break;
  }
}
void setup() {
